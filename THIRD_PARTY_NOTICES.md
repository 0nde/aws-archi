...
| --- | --- | --- | --- |
| Terraform | `.devcontainer/Dockerfile` | BUSL-1.1 | `third_party_licenses/terraform-1.16.2/LICENSE` |
...
| AWS CLI | `.devcontainer/Dockerfile` | Apache-2.0 and bundled third-party terms | `third_party_licenses/aws-cli-2.36.44/` |
